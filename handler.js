...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.kontak2 = [
        ['6289516947204', '𝚒𝚢𝚊𝚗Ⓒ︎', '𝑫𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓 𝑩𝒐𝒕', 'https://saweria.co/IyanMd', true],
        ['6289516947204', await this.getName('6289516947204@s.whatsapp.net'), '𝑷𝒂𝒓𝒕𝒏𝒆𝒓 𝚁𝙲𝚃𝙸 𝙱𝙾𝚃', 'https://saweria.co/IyanMd', true], 
        ]
